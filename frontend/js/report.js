...
async function dailyReportView(e) {
    try {
        ...
        const res = await axios.post("http://13.211.144.61:3000/premium/daily-report-view", reportData, {
            headers: {
                Authorization: token
            }
        });
...
async function dailyReportDownload(e) {
    try {
        ...
        const token = localStorage.getItem("token");
        const res = await axios.post("http://13.211.144.61:3000/premium/daily-report-download", reportData, {
            headers: {
                Authorization: token
            }
        });
...
async function monthlyReportView(e) {
    try {
        ...
        const token = localStorage.getItem("token");
        const res = await axios.post("http://13.211.144.61:3000/premium/monthly-report-view", reportData, {
            headers: {
                Authorization: token
            }
        });
...
async function monthlyReportDownload(e) {
    try {
        ...
        const token = localStorage.getItem("token");
        const res = await axios.post("http://13.211.144.61:3000/premium/monthly-report-download", reportData, {
            headers: {
                Authorization: token
            }
        });
